...
function semMensagem() {
    let mensagem = ('<div class="msgInicial">' +
        ' <img src="./assets/img/cadeado.jpg" width="336" alt="">' +
        '<p class="titulo">Nenhuma mensagem foi encontrada. Por favor tente inserir algum caractere permitido</p>' +
...
function error2() {
    ...
    let mensagem = ('<div class="msg_error">' +
        '<p class="titulo">ERROR</p>' +
        '<p class="msn_alerta">Digite algo caro ultilizador...' +
        '</div>');
    ...
    setTimeout(function () {
        ...
        errorFormatClass()
        semMensagem();
        document.getElementById("digiteTexto").placeholder = 'DIGITE UM TEXTO AQUI...';
    }, 2000
    );
    document.getElementById('areaDecodificacao').innerHTML += mensagem;
}
